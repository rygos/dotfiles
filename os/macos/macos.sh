...
sudo scutil --set ComputerName "mbp-ryg"
sudo scutil --set HostName "mbp-ryg"
sudo scutil --set LocalHostName "mbp-ryg"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "mbp-ryg"
...
# Use clmv view in all Finder windows by default
